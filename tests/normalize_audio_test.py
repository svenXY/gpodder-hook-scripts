...
from normalize_audio import hook
...
class TestNormalizeAudio(unittest.TestCase):
    ...
    def test_context_menu(self):
        ...
        self.assertTrue(norm_hook._show_context_menu([self.ogg_episode._episode,]))
        self.assertFalse(norm_hook._show_context_menu([self.flv_episode._episode,]))
